...
tasks.jar {
    ...
    destinationDirectory.set(file("../NexoLauncher/src/main/assets/components/lwjgl3/"))
    // Auto update the version with a timestamp so the project jar gets updated by Pojav
    doLast {
        val versionFile = file("../NexoLauncher/src/main/assets/components/lwjgl3/version")
