<div align="center">
    <img width="256" src="NexoLauncher/src/main/res/drawable/app_name_title.png"></img>
</div>

<div align="center">

[![Android CI](https://github.com/NexoLauncher/NexoLauncher/actions/workflows/android.yml/badge.svg)](https://github.com/NexoLauncher/NexoLauncher/actions/workflows/android.yml)
![Downloads](https://img.shields.io/github/downloads/NexoLauncher/NexoLauncher/total)
[![Sponsor](https://img.shields.io/badge/sponsor-30363D?logo=GitHub-Sponsors)](https://afdian.com/a/MovTery)

</div>

- <a href="/README.md">English</a>丨<a href="/README-ZH_TW.md">繁體中文</a>
- Nexo Launcher 是一款基于 [PojavLauncher](https://github.com/PojavLauncherTeam/PojavLauncher) 开发的 Minecraft 启动器，它能够在 Android 设备上运行 [Minecraft: Java Edition](https://www.minecraft.net/)。
- Nexo Launcher 致力于优化用户体验，重新设计了应用界面，新增了更多实用的功能，旨在最大程度地降低游玩门槛，让更多人能够轻松体验 Minecraft 的乐趣。

> [!WARNING]
> 注意！此项目只是一个**社区改版**，就像 PojavLauncher 是基于 [Boardwalk](https://github.com/zhuowei/Boardwalk) 开发的一样。  
> 我们正在计划搭建官方网站 [nexolauncher.cn](https://nexolauncher.cn)，注意，我们的网站后缀名为`.cn`，不是`.com`！**那并不是我们搭建的网站**！我们不参与、不接受、不信任那个网站！请您仔细辨别并保护好自己的个人隐私！
...
- Nexo Launcher 是在 GPL v3 协议下开源的。
