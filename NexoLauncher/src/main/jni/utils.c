...
JNIEXPORT void JNICALL Java_com_nexo_launcher_utils_JREUtils_setupBridgeSurfaceAWT(JNIEnv *env, jclass clazz, jlong surface) {
...
JNIEXPORT void JNICALL Java_com_nexo_launcher_utils_JREUtils_setLdLibraryPath(JNIEnv *env, jclass clazz, jstring ldLibraryPath) {
...
JNIEXPORT jboolean JNICALL Java_com_nexo_launcher_utils_JREUtils_dlopen(JNIEnv *env, jclass clazz, jstring name) {
...
JNIEXPORT jint JNICALL Java_com_nexo_launcher_utils_JREUtils_chdir(JNIEnv *env, jclass clazz, jstring nameStr) {
...
JNIEXPORT jint JNICALL Java_com_nexo_launcher_utils_JREUtils_executeBinary(JNIEnv *env, jclass clazz, jobjectArray cmdArgs) {
	jclass exception_cls = (*env)->FindClass(env, "java/lang/UnsatisfiedLinkError");
...
// METHOD 2
/*
JNIEXPORT jint JNICALL Java_com_nexo_launcher_utils_JREUtils_executeForkedBinary(JNIEnv *env, jclass clazz, jobjectArray cmdArgs) {
	int x, status;
	x = fork();
	if (x > 0) {
		wait(&status);
