...
import com.nexo.launcher.BuildConfig;
...
public final class ZHTools {
    ...
    /**
     * å±•ç¤ºä¸€ä¸ªæç¤ºå¼¹çª—ï¼Œå‘ŠçŸ¥ç”¨æˆ·æŽ¥ä¸‹æ¥å°†è¦åœ¨æµè§ˆå™¨å†…è®¿é—®çš„é“¾æŽ¥ï¼Œç”¨æˆ·å¯ä»¥é€‰æ‹©ä¸è¿›è¡Œè®¿é—®
     * @param link è¦è®¿é—®çš„é“¾æŽ¥
     */
     ...
     * å±•ç¤ºä¸€ä¸ªæç¤ºå¼¹çª—ï¼Œå‘ŠçŸ¥ç”¨æˆ·æŽ¥ä¸‹æ¥å°†è¦åœ¨æµè§ˆå™¨å†…è®¿é—®çš„é“¾æŽ¥ï¼Œç”¨æˆ·å¯ä»¥é€‰æ‹©ä¸è¿›è¡Œè®¿é—®
     * @param link è¦è®¿é—®çš„é“¾æŽ¥
     * @param dataType è®¾ç½® intent çš„æ•°æ®ä»¥åŠæ˜¾å¼ MIME æ•°æ®ç±»åž‹
     */
    ...
    /**
     * @return å¯åŠ¨å™¨æ˜¯å¦ä¸ºé¢„å‘å¸ƒç‰ˆ
     */
        ...
        view.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String css = "body { background-color: " + color[0] + "; color: " + color[1] + "; }" +
                        ...
                        "  pointer-events: none;" + //ç¦æ­¢é“¾æŽ¥çš„äº¤äº’æ€§
                        "}";

                //JavaScriptä»£ç ï¼Œç”¨äºŽå°†CSSæ ·å¼æ·»åŠ åˆ°WebViewä¸­
