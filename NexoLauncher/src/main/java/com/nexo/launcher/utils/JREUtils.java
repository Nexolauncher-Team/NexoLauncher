...
import static com.nexo.launcher.utils.path.PathManager.DIR_NATIVE_LIB;
import static com.nexo.launcher.Architecture.ARCH_X86;
import static com.nexo.launcher.Architecture.is64BitsDevice;
...
import com.nexo.launcher.event.value.JvmExitEvent;
...
public final class JREUtils {
    ...
    private static void setEnv(String jreHome, final Runtime runtime, Version gameVersion) throws Throwable {
        ...
        if (gameVersion != null) {
            ...
            envMap.put("NEXO_VERSION_CODE", String.valueOf(ZHTools.getVersionCode()));
        }
