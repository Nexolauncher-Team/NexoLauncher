...
import com.nexo.launcher.ui.dialog.EditTextDialog.ConfirmListener
...
class FileTools {
    companion object {
        ...
        fun getLatestFile(folder: File?, modifyTime: Long): File? {
            ...
            if (modifyTime > 0) {
                val difference =
                    (ZHTools.getCurrentTimeMillis() - fileList[0].lastModified()) / 1000 //è½¬æ¢ä¸ºç§’
        ...
        fun zipFile(file: File, entryName: String, zos: ZipOutputStream) {
            FileInputStream(file).use { fis ->
                ...
                zipEntry.time = file.lastModified() //ä¿ç•™æ–‡ä»¶çš„ä¿®æ”¹æ—¶é—´
        ...
        /**
         * å­—èŠ‚æ•°ç»„è½¬åå…­è¿›åˆ¶å­—ç¬¦ä¸²ï¼ˆé«˜æ•ˆå®žçŽ°ï¼‰
         */
