package com.nexo.launcher.ui.subassembly.adapter
...
/**
 * æ”¹è‡ª [com.skydoves.powerspinner.DefaultSpinnerAdapter]
 */
@SuppressLint("NotifyDataSetChanged")
class ObjectSpinnerAdapter<T>(
    powerSpinnerView: PowerSpinnerView,
    private val itemNameProvider: (T) -> String //æä¾›å‡½æ•°æ¥èŽ·å–å­—ç¬¦ä¸²
