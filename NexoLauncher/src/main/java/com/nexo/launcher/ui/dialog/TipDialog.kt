...
class TipDialog private constructor(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            //å¦‚æžœå¼€å¯äº†è­¦å‘Šæ¨¡å¼ï¼Œé‚£ä¹ˆå°±ä¸ºæ ‡é¢˜æ·»åŠ ä¸€ä¸ªçº¢è‰²çš„è­¦å‘Šå›¾æ ‡
            if (warning) {
    ...
    override fun show() {
        super.show()
        //å°è¯•ä¿®å¤ä¸€äº›è®¾å¤‡ä¸Šçš„Viewå®½åº¦ä¸æ­£ç¡®çš„é—®é¢˜ï¼Œåœ¨è¿™é‡Œè¿›è¡Œæµ‹é‡
