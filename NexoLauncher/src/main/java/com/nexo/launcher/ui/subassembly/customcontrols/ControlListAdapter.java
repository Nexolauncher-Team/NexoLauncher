...
import com.nexo.launcher.databinding.ItemControlListViewBinding;
...
import com.nexo.launcher.ui.dialog.ControlInfoDialog;
...
public class ControlListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class ValidViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(ControlItemBean controlItemBean) {
            ...
            //åˆå§‹åŒ–æŽ§åˆ¶å¸ƒå±€åç§°ï¼Œå¦‚æžœä¸ºç©ºï¼Œé‚£ä¹ˆå°†è®¾ç½®ä¸ºæ–‡ä»¶å
            ...
            //åˆå§‹åŒ–ä½œè€…åï¼Œå¦‚æžœæ²¡æœ‰å¡«å†™ï¼Œé‚£ä¹ˆå°±éšè—å®ƒ
