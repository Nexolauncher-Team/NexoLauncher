...
import com.nexo.launcher.databinding.FragmentVersionsListBinding
import com.nexo.launcher.databinding.ItemFavoriteFolderBinding
...
import com.nexo.launcher.ui.dialog.FavoritesVersionDialog
import com.nexo.launcher.ui.dialog.TipDialog
import com.nexo.launcher.ui.layout.AnimRelativeLayout
import com.nexo.launcher.ui.subassembly.customprofilepath.ProfileItem
import com.nexo.launcher.ui.subassembly.customprofilepath.ProfilePathAdapter
import com.nexo.launcher.ui.subassembly.version.VersionAdapter
        ...
        binding.apply {
            ...
            versionsAdapter = VersionAdapter(this@VersionsListFragment, object : VersionAdapter.OnVersionItemClickListener {
                ...
                override fun isVersionFavorited(versionName: String): Boolean {
                    //å¦‚æžœæ”¶è—æ é€‰æ‹©çš„ä¸æ˜¯â€œå…¨éƒ¨â€ï¼Œé‚£ä¹ˆå½“å‰ç‰ˆæœ¬ä¸€å®šä¼šæ˜¯è¢«æ”¶è—çš„çŠ¶æ€
    ...
    fun event(event: RefreshVersionsEvent) {
        binding.apply {
            TaskExecutors.runInUIThread {
                ...
                //æ— è®ºåˆ·æ–°è¿›åº¦ï¼Œéƒ½åº”è¯¥å…³é—­æ‰€æœ‰çš„æ“ä½œå¼¹çª—
                closeAllPopupWindow()
            }
        }
    }
