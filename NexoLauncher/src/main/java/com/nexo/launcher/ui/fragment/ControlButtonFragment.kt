...
import com.nexo.launcher.databinding.FragmentControlManagerBinding
...
import com.nexo.launcher.ui.subassembly.customcontrols.ControlSelectedListener
import com.nexo.launcher.ui.subassembly.customcontrols.ControlsListViewCreator
import com.nexo.launcher.ui.subassembly.customcontrols.EditControlData.Companion.createNewControlFile
import com.nexo.launcher.ui.subassembly.view.SearchViewWrapper
...
import com.nexo.launcher.utils.file.PasteFile
import com.nexo.launcher.CustomControlsActivity
        ...
        binding.operateView.apply {
            ...
            createFolderButton.setOnClickListener {
                ...
                editControlInfoDialog.setOnConfirmClickListener { fileName: String, controlInfoData: ControlInfoData ->
                    ...
                    if (file.exists()) { //æ£€æŸ¥æ–‡ä»¶æ˜¯å¦å·²ç»å­˜åœ¨
