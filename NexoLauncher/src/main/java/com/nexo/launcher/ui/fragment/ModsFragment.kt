...
import com.nexo.launcher.databinding.FragmentModsBinding
import com.nexo.launcher.feature.mod.ModToggleHandler
import com.nexo.launcher.feature.mod.ModUtils
...
import com.nexo.launcher.ui.subassembly.filelist.FileSelectedListener
...
import com.nexo.launcher.utils.file.FileCopyHandler
...
class ModsFragment : FragmentWithAnim(R.layout.fragment_mods) {
                    ...
                    override fun onFileSelected(file: File?, path: String?) {
                        file?.let {
                            if (it.isFile) {
                                ...
                                //æ£€æµ‹åŽç¼€åï¼Œä»¥è®¾ç½®æ­£ç¡®çš„æŒ‰é’®
    ...
    private fun parseBundle() {
        ...
        mRootPath = bundle.getString(BUNDLE_ROOT_PATH) ?: throw IllegalStateException("root path is not setï¼")
    }
