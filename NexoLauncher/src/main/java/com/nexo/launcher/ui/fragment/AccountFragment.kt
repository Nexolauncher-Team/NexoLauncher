...
import com.nexo.launcher.databinding.FragmentAccountBinding
import com.nexo.launcher.databinding.ItemOtherServerBinding
import com.nexo.launcher.databinding.ViewAddOtherServerBinding
import com.nexo.launcher.databinding.ViewSingleActionPopupBinding
...
import com.nexo.launcher.feature.accounts.LocalAccountUtils.CheckResultListener
import com.nexo.launcher.feature.accounts.LocalAccountUtils.Companion.checkUsageAllowed
import com.nexo.launcher.feature.accounts.LocalAccountUtils.Companion.openDialog
import com.nexo.launcher.feature.accounts.OtherLoginHelper
import com.nexo.launcher.feature.log.Logging
import com.nexo.launcher.feature.login.OtherLoginApi
import com.nexo.launcher.feature.login.Servers
import com.nexo.launcher.feature.login.Servers.Server
...
import com.nexo.launcher.ui.dialog.OtherLoginDialog
import com.nexo.launcher.ui.dialog.TipDialog
import com.nexo.launcher.ui.layout.AnimRelativeLayout
import com.nexo.launcher.ui.subassembly.account.AccountAdapter
import com.nexo.launcher.ui.subassembly.account.AccountAdapter.AccountUpdateListener
import com.nexo.launcher.ui.subassembly.account.AccountViewWrapper
import com.nexo.launcher.ui.subassembly.account.SelectAccountListener
...
import com.nexo.launcher.fragments.MicrosoftLoginFragment
...
class AccountFragment : FragmentWithAnim(R.layout.fragment_account), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            accountTypeTab.observeIndexChange { _, toIndex, _, fromUser ->
                ...
                if (fromUser) { //éœ€è¦åˆ¤æ–­æ˜¯å¦ä¸ºç”¨æˆ·æ‰‹åŠ¨ç‚¹å‡»çš„ï¼Œå¦åˆ™ä¼šä¸€ç›´è¿›å…¥å¾®è½¯ç™»å½•ç•Œé¢
                    when (toIndex) {
                        //å¾®è½¯è´¦æˆ·
                        ...
                        //å¤–ç½®è´¦æˆ·
                            ...
                            ) { otherLogin(toIndex - 2) /* Serverç´¢å¼•éœ€è¦ä»Ž0å¼€å§‹ */ }
                        }
                    }
                }
            }
    ...
    private fun refreshOtherServer() {
        Task.runTask {
            ...
            //å°†å¤–ç½®æœåŠ¡å™¨æ·»åŠ åˆ°è´¦å·ç±»åˆ«é€‰æ‹©æ ä¸Š
