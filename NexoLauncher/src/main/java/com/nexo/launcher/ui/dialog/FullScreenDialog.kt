...
abstract class FullScreenDialog(context: Context) : Dialog(context, R.style.CustomDialogStyle) {
    ...
    /**
     * ä¿®æ”¹è‡ªFCL [FCLAlertDialog.java](https://github.com/FCL-Team/FoldCraftLauncher/blob/e7d82af/FCLLibrary/src/main/java/com/tungsten/fcllibrary/component/dialog/FCLAlertDialog.java#L62-L77)
     */
