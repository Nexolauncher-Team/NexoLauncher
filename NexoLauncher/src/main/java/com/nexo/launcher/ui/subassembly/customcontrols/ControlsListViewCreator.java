...
import com.nexo.launcher.ui.dialog.DeleteDialog;
import com.nexo.launcher.ui.subassembly.filelist.RefreshListener;
import com.nexo.launcher.utils.path.PathManager;
import com.nexo.launcher.utils.file.FileTools;
import com.nexo.launcher.utils.stringutils.StringFilter;
        ...
        if (files != null) {
            for (File file : files) {
                if (file.isFile()) {
                    ...
                    if (file.getName().endsWith(".json")) { //åªæœ‰.jsonæ–‡ä»¶ä¼šè¢«å°è¯•è¯†åˆ«
