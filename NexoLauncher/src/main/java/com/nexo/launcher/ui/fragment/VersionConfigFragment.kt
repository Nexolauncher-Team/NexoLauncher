...
import com.nexo.launcher.databinding.FragmentVersionConfigBinding
import com.nexo.launcher.event.sticky.FileSelectorEvent
...
import com.nexo.launcher.feature.version.VersionConfig.CREATOR.getIsolationString
import com.nexo.launcher.feature.version.VersionConfig.IsolationType
import com.nexo.launcher.feature.version.VersionsManager.getCurrentVersion
...
import com.nexo.launcher.setting.AllSettings.Companion.versionIsolation
import com.nexo.launcher.task.Task
import com.nexo.launcher.task.TaskExecutors.Companion.getAndroidUI
...
import com.nexo.launcher.utils.file.FileTools.Companion.copyFileInBackground
...
class VersionConfigFragment : FragmentWithAnim(R.layout.fragment_version_config), View.OnClickListener {
    ...
    /**
     * åˆ·æ–°å›¾æ ‡ï¼Œå¹¶å¯¹é‡ç½®å›¾æ ‡çš„æŒ‰é’®æ’­æ”¾æ˜¾ç¤ºæˆ–éšè—çš„åŠ¨ç”»
     * @param init é¦–æ¬¡åˆ·æ–°ä¸éœ€è¦å¯¹é‡ç½®æŒ‰é’®æ’­æ”¾åŠ¨ç”»
     */
