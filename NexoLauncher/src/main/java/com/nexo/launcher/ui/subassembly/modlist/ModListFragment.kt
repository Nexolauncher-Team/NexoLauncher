package com.nexo.launcher.ui.subassembly.modlist
...
import com.nexo.launcher.databinding.FragmentModDownloadBinding
...
import com.nexo.launcher.utils.anim.AnimUtils.Companion.playVisibilityAnim
...
abstract class ModListFragment : FragmentWithAnim(R.layout.fragment_mod_download) {
    ...
    /**
     * å¦‚æžœä¸€ä¸ªMapä¸­æ²¡æœ‰åŒ…å«æŒ‡å®šKeyçš„Listé›†åˆï¼Œåˆ™åˆ›å»ºä¸€ä¸ªæ–°çš„ArrayListï¼Œå¹¶å°†å…ƒç´ æ·»åŠ è¿›åŽ»
     * å¦‚æžœè¿™ä¸ªMapä¸­å­˜åœ¨è¿™ä¸ªé›†åˆï¼Œåˆ™ç›´æŽ¥å°†å…ƒç´ æ·»åŠ è¿›åŽ»
     */
    ...
    fun switchToChild(adapter: RecyclerView.Adapter<*>?, title: String?) {
        if (currentTask!!.isDone && adapter != null) {
            binding.apply {
                //ä¿å­˜çˆ¶çº§ï¼Œè®¾ç½®é€‰ä¸­çš„æ ‡é¢˜æ–‡æœ¬ï¼Œåˆ‡æ¢è‡³å­çº§
