...
import com.nexo.launcher.databinding.ItemModDownloadBinding
import com.nexo.launcher.feature.download.enums.DependencyType
...
class ModListAdapter(
    ...
    inner class InnerHolder(private val binding: ItemModDownloadBinding) : RecyclerView.ViewHolder(
        ...
        /**
         * @return ModåŠ è½½å™¨çš„å›¾æ ‡ã€åç§°ï¼Œè‹¥æ²¡æœ‰ï¼Œåˆ™ä¸ºåŽŸç‰ˆè‰æ–¹å—ï¼Œä»¥åŠç©ºå­—ç¬¦ä¸²
         */
