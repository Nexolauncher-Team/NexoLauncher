...
import com.nexo.launcher.databinding.FragmentDownloadResourceBinding
import com.nexo.launcher.event.value.DownloadPageEvent
import com.nexo.launcher.event.value.DownloadPageEvent.PageSwapEvent.Companion.IN
import com.nexo.launcher.event.value.DownloadPageEvent.PageSwapEvent.Companion.OUT
import com.nexo.launcher.feature.download.Filters
import com.nexo.launcher.feature.download.InfoAdapter
import com.nexo.launcher.feature.download.SelfReferencingFuture
...
import com.nexo.launcher.feature.download.item.SearchResult
import com.nexo.launcher.feature.download.platform.PlatformNotSupportedException
import com.nexo.launcher.feature.log.Logging
import com.nexo.launcher.task.TaskExecutors
import com.nexo.launcher.ui.dialog.SelectVersionDialog
...
import com.nexo.launcher.ui.subassembly.versionlist.VersionSelectedListener
import com.nexo.launcher.utils.ZHTools
import com.nexo.launcher.utils.anim.AnimUtils.Companion.setVisibilityAnim
...
abstract class AbstractResourceDownloadFragment(
    ...
    /**
     * æ¸…é™¤ä¸Šä¸€æ¬¡çš„æœç´¢çŠ¶æ€ï¼Œç„¶åŽæ‰§è¡Œæœç´¢
     */
    private fun search() {
        setStatusText(false)
        setRecyclerView(false)
    ...
    /**
     * æ£€æŸ¥å½“å‰é€‚é…å™¨å†…çš„itemæ•°é‡æ˜¯å¦ä¸º0ï¼Œå¦‚æžœæ˜¯ï¼Œé‚£ä¹ˆæ‰§è¡Œæœç´¢
     */
