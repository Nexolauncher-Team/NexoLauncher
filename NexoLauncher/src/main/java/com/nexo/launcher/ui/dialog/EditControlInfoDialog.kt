...
import com.nexo.launcher.databinding.DialogEditControlInfoBinding
...
class EditControlInfoDialog(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            //è®¾ç½®hint
            fileNameEdit.setHint(R.string.generic_required) //å¿…å¡«
            nameEdit.setHint(R.string.generic_optional) //é€‰å¡«
