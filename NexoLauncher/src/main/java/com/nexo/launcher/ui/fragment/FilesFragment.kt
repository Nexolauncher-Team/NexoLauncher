...
import com.nexo.launcher.databinding.FragmentFilesBinding
        ...
        binding.apply {
            fileRecyclerView.apply {
                ...
                setRefreshListener {
                    ...
                    // å¦‚æžœç›®å½•å˜æ›´åˆ°äº†å¤–éƒ¨å­˜å‚¨ï¼Œåˆ™ä¼šæ£€æŸ¥æƒé™
            ...
            currentPath.setOnClickListener {
                EditTextDialog.Builder(requireContext())
                    ...
                    .setConfirmListener { editBox, _ ->
                        ...
                        val file = File(path)
                        //æ£€æŸ¥è·¯å¾„æ˜¯å¦ç¬¦åˆè¦æ±‚ï¼šæœ€å°‘ä¸ºæœ€é¡¶éƒ¨è·¯å¾„ã€è·¯å¾„æ˜¯ä¸€ä¸ªæ–‡ä»¶å¤¹ã€è¿™ä¸ªè·¯å¾„å­˜åœ¨
