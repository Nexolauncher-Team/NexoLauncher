...
import com.nexo.launcher.databinding.FragmentCustomBackgroundBinding
...
import com.nexo.launcher.feature.background.BackgroundManager.NULL
            ...
            fileRecyclerView.apply {
                ...
                setFileSelectedListener(object : FileSelectedListener() {
                    override fun onFileSelected(file: File?, path: String?) {
                        ...
                        //é»˜è®¤è™šæ‹Ÿé¼ æ ‡ä¸æ”¯æŒåˆ†äº«ã€é‡å‘½åã€åˆ é™¤æ“ä½œ
                        val message = if (image) { //å¦‚æžœé€‰ä¸­çš„ä¸æ˜¯ä¸€ä¸ªå›¾ç‰‡ï¼Œé‚£ä¹ˆå°†æ˜¾ç¤ºé»˜è®¤çš„æ–‡ä»¶é€‰æ‹©æç¤ºä¿¡æ¯
