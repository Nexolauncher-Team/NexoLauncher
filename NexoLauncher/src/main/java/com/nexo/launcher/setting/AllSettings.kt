...
import com.nexo.launcher.setting.unit.BooleanSettingUnit
import com.nexo.launcher.setting.unit.IntSettingUnit
import com.nexo.launcher.setting.unit.LongSettingUnit
import com.nexo.launcher.setting.unit.StringSettingUnit
...
class AllSettings {
    companion object {
        ...
        val ramAllocation = lazy {
            //æ¶‰åŠåˆ°Contextåˆå§‹åŒ–ï¼Œéœ€è¦è¿›è¡Œæ‡’åŠ è½½
