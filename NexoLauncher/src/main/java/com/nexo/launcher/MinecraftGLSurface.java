...
import static com.nexo.launcher.MainActivity.touchCharInput;
...
import com.nexo.launcher.customcontrols.gamepad.DefaultDataProvider;
import com.nexo.launcher.customcontrols.gamepad.Gamepad;
import com.nexo.launcher.customcontrols.mouse.AbstractTouchpad;
import com.nexo.launcher.customcontrols.mouse.AndroidPointerCapture;
import com.nexo.launcher.customcontrols.mouse.InGUIEventProcessor;
import com.nexo.launcher.customcontrols.mouse.InGameEventProcessor;
import com.nexo.launcher.customcontrols.mouse.TouchEventProcessor;
            ...
            textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
                ...
                public void onSurfaceTextureUpdated(@NonNull SurfaceTexture surface) {
                    if (!mIsRenderingStarted) {
                        ...
                        //åœ¨æ­£å¼æ¸²æŸ“ç”»é¢çš„æ—¶å€™ï¼Œè°ƒç”¨è¿™ä¸ªç›‘å¬å™¨ï¼Œå…³é—­å¯åŠ¨å™¨èƒŒæ™¯å›¾åƒï¼Œé˜²æ­¢ä¸€äº›è®¾å¤‡çš„åŠé€æ˜Žé—®é¢˜
