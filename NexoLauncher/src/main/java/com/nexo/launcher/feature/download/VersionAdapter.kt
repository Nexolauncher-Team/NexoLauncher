...
import com.nexo.launcher.databinding.ItemModVersionBinding
...
import com.nexo.launcher.ui.dialog.ModDependenciesDialog
import com.nexo.launcher.utils.NumberWithUnits.Companion.formatNumberWithUnit
...
class VersionAdapter(
    ...
    init {
        mData?.sortedWith { o1, o2 ->  //æŒ‰ç…§æ—¥æœŸè¿›è¡Œä¸€æ³¢æŽ’åº
