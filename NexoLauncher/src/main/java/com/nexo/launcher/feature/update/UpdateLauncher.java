...
import static com.nexo.launcher.task.TaskExecutors.runInUIThread;
import static com.nexo.launcher.utils.file.FileTools.formatFileSize;
import static com.nexo.launcher.utils.path.UrlManager.TIME_OUT;
...
public final class UpdateLauncher {
    ...
    private void handleDownloadError(Exception e) {
        if (isCanceled) {
            //å·²ç»å–æ¶ˆäº†ä¸‹è½½ï¼Œä¸å¤„ç†å–æ¶ˆå¸¦æ¥çš„ä»»ä½•å¼‚å¸¸
            return;
        }
