...
/**
 * CurseForgeä¸ŽModrinthåŒå¹³å°çš„ç±»åˆ«æ±‡é›†ï¼Œè®°å½•ç±»åˆ«æ‰€ä»£æŒ‡çš„å®žé™…å€¼ï¼Œä»¥ä¾¿æœç´¢èµ„æºæ—¶å¡«å…¥ç±»åˆ«ã€‚
 * å¦‚æžœæŸç±»åˆ«çš„curseforge idæˆ–modrinth idä¸ºnullï¼Œé‚£ä¹ˆå°±ä»£è¡¨æ­¤ç±»åˆ«åœ¨è¯¥å¹³å°ä¸å­˜åœ¨
 */
enum class Category(val classify: Classify, val resNameID: Int, val curseforgeID: String?, val modrinthName: String?) {
    ...
    //Modä¸ŽModPackæ•°æ®æ¥æºï¼šhttps://github.com/Hex-Dragon/PCL2/blob/f40a2990103ae85c34acb5d8d367ab1644aa7ca6/Plain%20Craft%20Launcher%202/Modules/Minecraft/ModComp.vb#L281
    //æ„Ÿè°¢é¾™è…¾çŒ«è·ƒ!!!!
    //Modç±»åˆ«
