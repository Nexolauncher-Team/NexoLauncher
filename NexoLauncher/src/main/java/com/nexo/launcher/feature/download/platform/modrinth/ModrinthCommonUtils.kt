...
import com.nexo.launcher.feature.download.utils.PlatformUtils.Companion.safeRun
    ...
    companion object {
        ...
        private fun getInfoItem(hit: JsonObject, classify: Classify): InfoItem? {
            ...
            for (category in categories) {
                if (category.asString == "datapack") return null //æ²¡æœ‰æ•°æ®åŒ…å®‰è£…çš„éœ€æ±‚ï¼Œä¸€å¾‹æŽ’é™¤
            }
            return InfoItem(
                classify,
                Platform.MODRINTH,
        ...
        internal fun <T> getCommonVersions(
            ...
            //å¦‚æžœç¬¬ä¸€æ¬¡èŽ·å–ä¾èµ–ä¿¡æ¯å¤±è´¥ï¼Œåˆ™è®°å½•å…¶idï¼Œä¹‹åŽä¸å†å°è¯•èŽ·å–
