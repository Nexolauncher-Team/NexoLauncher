package com.nexo.launcher.feature.log

import android.util.Log
import com.nexo.launcher.BuildConfig
import com.nexo.launcher.InfoDistributor
import com.nexo.launcher.utils.path.PathManager.Companion.DIR_LAUNCHER_LOG
...
/**
 * å¯åŠ¨å™¨æ—¥å¿—è®°å½•ï¼Œå°†è½¯ä»¶æ—¥å¿—åŠæ—¶å†™å…¥æœ¬åœ°æ–‡ä»¶å­˜å‚¨
 */
object Logging {
