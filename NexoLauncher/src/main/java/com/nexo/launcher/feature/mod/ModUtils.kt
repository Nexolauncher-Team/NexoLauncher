package com.nexo.launcher.feature.mod

import com.nexo.launcher.utils.file.FileTools.Companion.renameFile
import java.io.File
...
class ModUtils {
    companion object {
        ...
        fun enableMod(file: File?) {
            ...
            if (!fileName.endsWith(JAR_FILE_SUFFIX)) newFileName += JAR_FILE_SUFFIX //å¦‚æžœæ²¡æœ‰.jarç»“å°¾ï¼Œé‚£ä¹ˆé»˜è®¤åŠ ä¸Š.jaråŽç¼€
