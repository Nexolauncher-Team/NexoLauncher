package com.nexo.launcher.feature.download.platform.modrinth

import com.google.gson.JsonArray
import com.google.gson.JsonObject
import com.nexo.launcher.feature.download.Filters
import com.nexo.launcher.feature.download.InfoCache
...
import com.nexo.launcher.feature.download.item.ModInfoItem
...
import com.nexo.launcher.feature.download.utils.DependencyUtils
import com.nexo.launcher.feature.download.utils.ModLoaderUtils
import com.nexo.launcher.feature.download.utils.PlatformUtils
import com.nexo.launcher.feature.download.utils.VersionTypeUtils
        ...
        internal fun modLikeSearch(api: ApiHandler, lastResult: SearchResult, filters: Filters, type: String, classify: Classify): SearchResult? {
            ...
            responseHit@for (responseHit in responseHits) {
                ...
                for (category in categories) {
                    ...
                    if (string == "datapack") continue@responseHit //è¿™é‡Œç»å¸¸èƒ½æœåˆ°æ•°æ®åŒ…ï¼Œå¾ˆå¥‡æ€ª...
