...
import static com.nexo.launcher.launch.LaunchGame.preLaunch;
import static com.nexo.launcher.Tools.currentDisplayMetrics;
...
import com.nexo.launcher.databinding.ActivityLauncherBinding;
import com.nexo.launcher.event.single.LaunchGameEvent;
import com.nexo.launcher.event.single.MainBackgroundChangeEvent;
import com.nexo.launcher.event.single.PageOpacityChangeEvent;
import com.nexo.launcher.event.single.SwapToLoginEvent;
import com.nexo.launcher.event.sticky.MinecraftVersionValueEvent;
import com.nexo.launcher.event.value.AddFragmentEvent;
import com.nexo.launcher.event.value.DownloadProgressKeyEvent;
import com.nexo.launcher.event.value.InstallGameEvent;
import com.nexo.launcher.event.value.InstallLocalModpackEvent;
import com.nexo.launcher.event.value.LocalLoginEvent;
import com.nexo.launcher.event.value.MicrosoftLoginEvent;
import com.nexo.launcher.event.value.OtherLoginEvent;
import com.nexo.launcher.feature.accounts.AccountType;
import com.nexo.launcher.feature.accounts.AccountsManager;
import com.nexo.launcher.feature.accounts.LocalAccountUtils;
...
import com.nexo.launcher.feature.mod.modpack.install.InstallExtra;
import com.nexo.launcher.feature.mod.modpack.install.InstallLocalModPack;
import com.nexo.launcher.feature.mod.modpack.install.ModPackInfo;
import com.nexo.launcher.feature.mod.modpack.install.ModPackUtils;
import com.nexo.launcher.feature.notice.CheckNewNotice;
import com.nexo.launcher.feature.notice.NoticeInfo;
...
import com.nexo.launcher.feature.version.install.GameInstaller;
import com.nexo.launcher.feature.version.install.InstallTask;
import com.nexo.launcher.plugins.renderer.RendererPlugin;
import com.nexo.launcher.plugins.renderer.RendererPluginManager;
...
import com.nexo.launcher.ui.fragment.BaseFragment;
import com.nexo.launcher.ui.fragment.DownloadFragment;
import com.nexo.launcher.ui.fragment.DownloadModFragment;
import com.nexo.launcher.ui.fragment.SettingsFragment;
import com.nexo.launcher.ui.subassembly.settingsbutton.ButtonType;
import com.nexo.launcher.ui.subassembly.settingsbutton.SettingsButtonWrapper;
...
import com.nexo.launcher.utils.stringutils.ShiftDirection;
...
import com.nexo.launcher.fragments.MainMenuFragment;
...
import com.nexo.launcher.services.ProgressServiceKeeper;
import com.nexo.launcher.tasks.AsyncVersionList;
import com.nexo.launcher.utils.NotificationUtils;
...
public class LauncherActivity extends BaseActivity {
    ...
    public void event(SwapToLoginEvent event) {
        ...
        //å¦‚æžœå½“å‰å¯è§çš„Fragmentä¸ä¸ºç©ºï¼Œåˆ™åˆ¤æ–­å½“å‰çš„Fragmentæ˜¯å¦ä¸ºAccountFragmentï¼Œä¸æ˜¯å°±è·³è½¬è‡³AccountFragment
    ...
    private void processFragment() {
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                if (currentFragment instanceof BaseFragment && !((BaseFragment) currentFragment).onBackPressed()) {
                    //Fragmenté‚£è¾¹æ‹’ç»äº†è¿”å›žäº‹ä»¶
                    return;
                }

                //å¦‚æžœæ ˆä¸­åªå‰©ä¸‹1ä¸ªæˆ–æ²¡æœ‰Fragmentï¼Œåˆ™ç›´æŽ¥é€€å‡ºå¯åŠ¨å™¨
        ...
        //å¦‚æžœæ ˆä¸­æ²¡æœ‰Fragmentï¼Œé‚£ä¹ˆå°±å°†ä¸»Fragmentæ·»åŠ è¿›æ¥
    ...
    private void checkNotice() {
        checkNotice = TaskExecutors.getDefault().submit(() -> CheckNewNotice.checkNewNotice(noticeInfo -> {
            ...
            //å½“åå¥½è®¾ç½®å†…æ˜¯å¼€å¯é€šçŸ¥æ  æˆ–è€… æ£€æµ‹åˆ°é€šçŸ¥ç¼–å·ä¸ä¸ºåå¥½è®¾ç½®é‡Œä¿å­˜çš„å€¼æ—¶ï¼Œæ˜¾ç¤ºé€šçŸ¥æ 
