...
val getGeminiApiKey = {
    ...
    localProperties.getProperty("gemini.api.key") ?: "DUMMY"
}
...
android {
    ...
    sourceSets["main"].java.srcDirs(generatedNexoDir)
...
tasks.register("generateInfoDistributor") {
    doLast {
        val constantMap = mapOf(
            ...
            "GEMINI_API_KEY" to getGeminiApiKey(),
        ...
        generateJavaClass(generatedNexoDir, "com.nexo.launcher", "InfoDistributor", constantMap)
    }
}
